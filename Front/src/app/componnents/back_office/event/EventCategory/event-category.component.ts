...
import { EventCategoryService, EventCategory } from 'src/app/services/event/event-category.service';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule], // ✅ nécessaires pour ngModel et routerLink
